    ...
    <svg
      ...
      <g filter="url(#filter0_d)">
        <path
          ...
          fillOpacity="0.01"
          fillRule="evenodd"
          d="M41 70c12.15 0 22-9.85 22-22s-9.85-22-22-22-22 9.85-22 22 9.85 22 22 22z"
      ...
      <g filter="url(#filter1_d)">
        ...
        <path
          stroke="#42A5F5"
          strokeWidth="4"
          d="M69 40c0 15.464-12.536 28-28 28S13 55.464 13 40s12.536-28 28-28 28 12.536 28 28z"></path>
      </g>
      <mask
        id="a"
        width="60"
      ...
      <g stroke="#42A5F5" strokeWidth="4" mask="url(#a)">
        <path
          strokeLinecap="square"
          d="M13.714 32.875h53.822M13.714 48.625h53.822"></path>
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M40.25 14.5s-9.962 11.578-9.747 26.25C30.72 55.422 40.25 65.5 40.25 65.5M41 14.5s9.962 11.578 9.746 26.25C50.531 55.422 41 65.5 41 65.5"></path>
      </g>
      <path
        fill="#fff"
        fillRule="evenodd"
      ...
      <g mask="url(#b)">
        <path
          fill="#EBECF2"
          d="M45.536 30.784H46.845V43.192H45.536z"
          transform="rotate(60 45.536 30.784)"></path>
        <path
          fill="#DEE1E3"
          fillRule="evenodd"
        ...
        <path
          fill="#C5C6CC"
          fillRule="evenodd"
          d="M39.248 43.213l9.13-5.27.099 2.01-7.521 6.6-1.708-3.34z"
          clipRule="evenodd"></path>
        <path
          fill="#DEE1E3"
          fillRule="evenodd"
      ...
      <defs>
        <filter
          ...
          <feColorMatrix values="0 0 0 0 0.215686 0 0 0 0 0.407843 0 0 0 0 0.556863 0 0 0 0.25 0"></feColorMatrix>
          <feBlend
        ...
        <filter
          ...
          <feGaussianBlur stdDeviation="5.5"></feGaussianBlur>
          <feColorMatrix values="0 0 0 0 0.215686 0 0 0 0 0.407843 0 0 0 0 0.556863 0 0 0 0.3 0"></feColorMatrix>
          <feBlend
            in2="BackgroundImageFix"
            result="effect1_dropShadow"></feBlend>
          <feBlend
